...
def test_operation(
    ...
    bonus.transferFrom(bonus_liquidity, gov, Wei("30000 ether"), {"from": bonus_liquidity})
    ...
    ticket.transferFrom(ticket_liquidity, gov, Wei("3000 ether"), {"from": ticket_liquidity})
